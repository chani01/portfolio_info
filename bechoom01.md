# 🌙 비춤 0.1 (Bechoom 0.1)
> **무의식을 비추는 거울, AI 기반 꿈 분석 및 정신적 성장 플랫폼**
> "사용자가 기록한 꿈을 AI가 분석하여 자기 이해와 심리적 성장을 돕습니다."
...
## 📝 개요
'비춤'은 사람들이 간밤에 꾼 꿈을 기록하면 AI가 이를 분석하여 심리적 의미를 해석해 주는 서비스입니다. 무의식의 영역인 꿈을 데이터화하고 시각화하여 현대인들이 자신을 더 깊이 이해할 수 있도록 돕는 도정의 시작입니다.
...
## 🛠 기술 및 도구
1인 개발 프로젝트로서 최신 안드로이드 아키텍처와 AI 연동을 위한 데이터 통신 기술을 적극 도입했습니다.
...
## 🚀 핵심 기능 구현
**개발 기여도 100%**로 AI 엔진 연동부터 클라이언트 앱 구축까지 전 과정을 전담했습니다.

### 1. AI 기반 꿈 분석 시스템
* **심층 분석 엔진 연동**: AI 모델을 활용하여 사용자가 입력한 꿈의 내용을 분석하고 심리적 해석을 제공하는 핵심 로직 구현
* **백그라운드 분석 프로세스**: 분석 작업이 진행되는 동안 사용자 경험을 저해하지 않도록 백그라운드 처리 로직 설계

### 2. 효율적인 데이터 관리 및 통신
* **GraphQL 도입**: 필요한 데이터만 효율적으로 쿼리하여 네트워크 리소스를 최적화하고 유연한 데이터 통신 환경 구축
* **Cloud Firestore & Room**: 실시간 클라우드 데이터 동기화와 오프라인 환경을 위한 로컬 DB(Room) 연동

### 3. 히스토리 및 사용자 경험
* **꿈 히스토리 리스트**: 과거에 분석한 꿈의 목록을 날짜별/키워드별로 체계적으로 관리할 수 있는 아카이브 기능 구현
* **선언형 UI 구현**: Jetpack Compose를 전면 도입하여 매끄럽고 현대적인 사용자 인터페이스 구축
...
## 📊 기여도 및 역할
* **Development (100%)**: 아키텍처 설계, AI 연동, 데이터베이스 설계 및 UI 개발 전과정 주도
* **Planning (25%)**: 서비스 기획 및 초기 아이디에이션 참여
...
<img src="https://img.shields.io/badge/ide-%23121011?style=for-the-badge">![Android Studio](https://img.shields.io/badge/android%20studio-346ac1?style=for-the-badge&logo=android%20studio&logoColor=white)

<img src="https://img.shields.io/badge/database-%23121011?style=for-the-badge">![Firebase](https://img.shields.io/badge/firebase-a08021?style=for-the-badge&logo=firebase&logoColor=ffcd34)
