...
## 🚀 주요 구현 기능
**개발 기여도 75%**로 앱의 UI/UX 혁신과 기능적 확장을 주도했습니다.

### 1. UI/UX 전면 개편 및 탐색 강화
* **홈 화면 1, 2차 개편**: Jetpack Compose를 활용하여 보다 현대적이고 반응성이 뛰어난 메인 인터페이스 구축
* **검색 엔진 고도화**: 대량의 미디어 속에서 원하는 순간을 빠르게 찾을 수 있는 **키워드 검색 기능** 구현
* **업로드 최적화**: 영상 업로드 시간 확장 및 **중복 업로드 체크** 로직을 통한 데이터 무결성 확보

### 2. 커머스 및 마케팅 인프라 구축
* **인앱 마케팅 시스템 '쑥톡'**: 마케팅 팀이 직접 유저와 소통할 수 있는 인앱 커뮤니케이션 툴 개발
* **굿즈 제작 플랫폼**: 유저의 기록을 실물 상품으로 연결하는 굿즈 제작 기능 연동 및 매출 다변화
...
## 📊 기여도 및 역할
* **Development (75%)**: Jetpack Compose 도입 주도 및 대규모 트래픽 대응을 위한 로직 최적화
* **Planning (40%)**: 커머스 모델 연동 기획 및 마케팅 자동화 툴 설계 참여
...
🗂목차
  ...
  3. [사용 스킬](https://github.com/chani01/portfolio_info/blob/main/babyFolio2022.md#%EC%82%AC%EC%9A%A9-%EC%8A%A4%ED%82%AC)<br>
...
## 사용 스킬
> 클린아키텍처, MVVM, DI, corutine, jetpack compose, roomDB, firebase App Distribution
